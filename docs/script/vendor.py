...
용법:
    python3 docs/script/vendor.py --full [--dry-run]     # 전량 벤더(초기 설치)
    python3 docs/script/vendor.py --update [--dry-run]   # baseline 대비 delta 업데이트
...
REPO_ROOT = Path(__file__).resolve().parents[2]   # docs/script/vendor.py → repo 루트
