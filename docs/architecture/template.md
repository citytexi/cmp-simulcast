...
platforms:                     # 예: android, ios, desktop, common
verified: YYYY-MM-DD           # 코드와 대조 확인한 날짜
related_adr:
related_architecture:
related_code:                  # 파일명#심볼 (라인번호·hex·변동수치 금지)
tags: [architecture]
---
...
<!--
사용법 (작성 후 이 주석 삭제):
- `docs/architecture/<id>.md`로 저장, frontmatter 채우고 `docs/architecture/README.md` 인덱스에 한 줄 추가.
